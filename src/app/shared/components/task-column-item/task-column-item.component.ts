...
export class TaskColumnItemComponent {
  ...
  task: Task = new Task({ id: 'fegt', title: 'headline', description: 'description', dueDate: '01.40.2025', priority: Priority.URGENT, category: Category.USERSTORY, assignedTo: ['a', 'b'], subtasks: false }) 
